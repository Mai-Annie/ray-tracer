        ...
        void render(const hittable& world){
            ...
            for (int j = 0; j < image_height; j++) {
                ...
                for (int i = 0; i < image_width; i ++){
                    ...
                    auto ray_direction = pixel_center - center; // calculate the ray direction from the camera center to the pixel center
                    ray r(center, ray_direction); // construct the ray from the camera center in the
                    color pixel_color = ray_color(r, world); // get the color for the ray
